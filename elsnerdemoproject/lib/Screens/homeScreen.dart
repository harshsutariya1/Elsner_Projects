...
// ________________________________________________________________________________________
        body: SingleChildScrollView(
          child: SizedBox(
            // If your screen is getting blank after wrapping a Column widget with a 
            //SingleChildScrollView, it could be due to the way the 
            //SingleChildScrollView is handling the available space. By default, 
            //the SingleChildScrollView takes up all the available space in 
            //its parent widget, which may cause the child Column to shrink and appear empty.
